...
return [
    ...
    'placeholder_by_html_type' => [
        'text' => 'Capturar [% field_name %] ...',
        'number' => 'Capturar [% field_name %] ...',
        'password' => 'Capturar [% field_name %] ...',
        'email' => 'Capturar [% field_name %] ...',
        'select' => 'Seleccionar [% field_name %]',
        'multipleSelect' => 'Seleccionar [% field_name %]',
    ],
    ...
    'generic_view_labels' => [
        'create' => [
            'text' => 'Crear Nuevo [% model_name_title %]',
            'template' => 'create_model',
        ],
        'delete' => [
            'text' => 'Borrar [% model_name_title %]',
            'template' => 'delete_model',
            'in-function-with-collective' => true,
        ],
        'edit' => [
            'text' => 'Editar [% model_name_title %]',
            'template' => 'edit_model',
        ],
        'show' => [
            'text' => 'Mostrar [% model_name_title %]',
            'template' => 'show_model',
        ],
        'show_all' => [
            'text' => 'Mostrar Todos [% model_name_title %]',
        ...
        'none_available' => [
            'text' => 'No hay [% model_name_plural_title %] Disponibles!',
        ...
        'model_was_added' => [
            'text' => '[% model_name_title %] fué agregado exitosamente!',
            'template' => 'model_was_added',
        ],
        'model_was_updated' => [
            'text' => '[% model_name_title %] fué actualizado exitosamente!',
            'template' => 'model_was_updated',
        ],
        'model_was_deleted' => [
            'text' => '[% model_name_title %] fué borrado exitosamente!',
            'template' => 'model_was_deleted',
        ],
        'unexpected_error' => [
            'text' => 'Problema inesperado al procesar su petición!',
