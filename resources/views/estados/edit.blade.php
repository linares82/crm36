...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Estado' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('estados.estado.update', $estado->id) }}" id="edit_estado_form" name="edit_estado_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @include ('estados.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('estados.update') }}">
                    </div>
                </div>
            </form>
