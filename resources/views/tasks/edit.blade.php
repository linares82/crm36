...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Task' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('tasks.task.update', $task->id) }}" id="edit_task_form" name="edit_task_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @include ('tasks.form', [
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <input class="btn btn-primary" type="submit" value="{{ trans('tasks.update') }}">
                    </div>
                </div>
            </form>
